...
<div class="container">
  ...
  <body>
   ...
   <form action="<?php echo base_url('index.php/Film/update_proses'); ?>" method="POST" enctype="multipart/form-data"> <!-- base url hanya bisa di php -->
      <input type="hidden" name="filelama" value="<?=$flm->gambar?>">
   		<div class="form-group">
        <label for="inputName3" class="col-sm-2 col-form-label">ID Film</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" name="id_film" placeholder="Nama Film" value="<?php echo $flm->id_film; ?>" readonly>
        </div>
      </div>
      <div class="form-group">
        <label for="inputName3" class="col-sm-2 col-form-label">Nama Film</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" name="nama_film" placeholder="Nama Film" value="<?php echo $flm->nama_film; ?>">
        </div>
      </div>
      <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="date" class="form-control" name="tgl_rilis" value="<?php echo $flm->tgl_rilis; ?>">
      </div>
    </div>
    <div class="form-group">
      <label for="inputName3" class="col-sm-2 col-form-label">Produksi</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" name="produksi" placeholder="Produksi" value="<?php echo $flm->produksi; ?>">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <textarea class="form-control" name="sinopsis" placeholder="Masukan Sinopsis" rows="9"><?php echo $flm->sinopsis; ?></textarea>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" name="durasi" placeholder="(Menit)" value="<?php echo $flm->durasi; ?>">
      </div>
    </div>
    <div class="form-group">
      <label for="inputName3" class="col-sm-2 col-form-label">Trailer</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" name="trailer" placeholder="Video Embed" value="<?php echo $flm->trailer; ?>">
      </div>
    </div>
